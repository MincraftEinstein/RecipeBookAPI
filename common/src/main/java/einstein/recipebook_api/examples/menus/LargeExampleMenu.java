...
public class LargeExampleMenu extends RecipeBookMenu<ExampleRecipeInput, ExampleRecipe> {
    ...
    public LargeExampleMenu(int id, Inventory inventory) {
        super(ModExamples.LARGE_EXAMPLE_MENU.get(), id);
